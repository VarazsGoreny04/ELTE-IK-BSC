module Péntek where
import Data.Char
-- import Data.List -- words függvényt tartalmazza
...
fromJust :: Maybe a -> a
fromJust (Just x) = x
fromJust Nothing = error "A fromJust nem kaphat Nothing értéket!"
...
{-
    words "esett egy nagy eső" = ["esett", "egy", "nagy", "eső"]
