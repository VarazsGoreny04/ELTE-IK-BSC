...
namespace Huszár
{
    internal class Program
    {
        ...
        static void Input()
        {
            ...
            bool lengthError = false, typeError = false, dataError = false, rowError = false, cullumnError = false, moveError = false;
            do
            {
        ...
        static void Calculation()
        {
            ...
            {
                //Ha túl nagy lenne az input és fölösleges a számítás, akkor kihagyja
                if (start[2] > 5)
                    break;
        ...
        static void Display()
        {
            //Csak akkor csinálja, ha számítással kellett megoldani a feladatot 
            if (start[2] < 6)
            {
