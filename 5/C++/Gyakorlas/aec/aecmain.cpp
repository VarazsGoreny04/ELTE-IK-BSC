...
int main()
{
  ...
  /*  std::cout << (2 == cas.size()) << std::endl;
   std::cout << ("Hello" == cas.at(0)) << std::endl;
   std::cout << (6 == c.at(1)) << std::endl;
   std::cout << (1 == c.at(0)) << std::endl;
   std::cout << (max == s.size()) << std::endl;
   std::cout << (1 == s.at(max / 2)) << std::endl;
   std::cout << (max - 2 == s.at(0)) << std::endl;

   std::cout << (1 == c.at(0)) << " = " << c.at(0) << std::endl;
   std::cout << (6 == c.at(1)) << " = " << c.at(1) << std::endl;
   std::cout << (2 == c.at(2)) << " = " << c.at(2) << std::endl;
   std::cout << (4 == c.at(3)) << " = " << c.at(3) << std::endl;
   std::cout << std::endl; */
  ...
  std::cout << (3 == ea.size()) << std::endl;
  std::cout << (1.5 > ea[1]) << std::endl;
