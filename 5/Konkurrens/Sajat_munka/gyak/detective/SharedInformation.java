/**
 * Singletion osztaly a kozos informaciok tarolasara, amit a detektivek a
 * kihallgatasok alatt
 * szereznek.
 * Amikor a megszerzett informacio 100% lesz, abbahagyjak a nyomozas
 * kihallgatasi fazisat.
 */
public class SharedInformation {
    private static final int INFORMATION_PERCENT_GOAL = 100;

    private static SharedInformation instance;
    // TODO 1. Resz: Keszitsuk el az informationPercent valtozot, hogy nyomon
    // kovessuk a megszerzett informacio szazalekat
    // TODO 1. Resz: informationPercent = 0
    private static int informationPercent = 0;
    // TODO 1. Resz: Keszitsuk el az gatheringInformation valtozot, hogy nyomon
    // kovessuk, hogy meg info gyujtesi fazis van, vagy nem
    // TODO 1. Resz: gatheringInformation = true
    private static boolean gatheringInformation = true;
    ...
    /**
     * Egy detektiv ezzel a metodussal kontributal a megszerzett informaciok
     * tarhazahoz.
    ...
    public synchronized void addNewInformation(final int percent) {
        // TODO 1. Resz: Biztositsuk be, hogy az informationPercent nem mehet 100 fole,
        // adjuk hozza a percent erteket
        informationPercent = informationPercent + percent > INFORMATION_PERCENT_GOAL ? INFORMATION_PERCENT_GOAL
        ...
        if (gatheringInformation) {
            if (informationPercent == INFORMATION_PERCENT_GOAL) {
                System.out.println("Got all the information needed!");
                gatheringInformation = false;
            }
            // TODO 1. Resz: Ha az informationPercent a percent hozzaadasa utan nem erte meg
            // el a 100-at,
