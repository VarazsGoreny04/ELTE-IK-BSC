...
public class Szemely
{
	...
	public static void Foglal(Szinhaz szinhaz, string cim, Ido ido, Terem terem, Foglalas foglalas)
	{
		szinhaz.Lefoglal(cim, ido, terem, foglalas);
	}

	public static void Lemond(Szinhaz szinhaz, string cim, Ido ido, Terem terem, Foglalas foglalas)
	{
